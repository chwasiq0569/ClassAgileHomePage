...
const StickyMenu = ({scrollToSection}) => {
    ...
    <div className="auto-container clearfix" >
        <div data-ga-tag="classAgile" className="logo pull-left" style={{ marginTop: '0.75rem'}} onClick={() => scrollToSection("headerSectionClass")}>
            <img width="150px" height="70px" src="images/logos/class-agile_full-logo.svg" alt="" title="" />
        </div>
